...
class LOOPBACKPSEQ(blankSeq.MRIBLANKSEQ):
    def __init__(self):
        super(LOOPBACKPSEQ, self).__init__()
    ...
    def sequenceRun(self, plotSeq=0, demo=False, standalone=False):
        ...
        delay_TR = TR - pp.calc_duration(rf90) / 2 - pp.calc_duration(gx) / 2 - 0
        ...
        def createBatches():
            ...
            for k_ex in range(Ny):
                ...
                for s in range(n_slices):
                    ...
                    #     gz_reph.amplitude = 0
                    batches[batch_num].add_block(rf90, adc)
            ...
            batches[batch_num].set_definition(key="Name", value="loopback")
    ...
    def sequenceAnalysis(self, mode=None):
        ...
        result1 = {'widget': 'curve',
                   'xData': tVector,
                   'yData': [np.abs(signal), np.angle(signal)],
                   'xLabel': 'Time (ms)',
