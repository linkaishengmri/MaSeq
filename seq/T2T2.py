...
class FidRectPSEQ(blankSeq.MRIBLANKSEQ):
    def __init__(self):
        ...
        self.addParameter(key='rfRectExTime', string='RF rect excitation time (us)', val=50, units=units.ms, field='RF')
        self.addParameter(key='rfReFA', string='Refocusing flip angle (deg)', val=180, field='RF')
        self.addParameter(key='rfRectReTime', string='RF rect refocusing time (us)', val=50, units=units.ms, field='RF')
        self.addParameter(key='tau', string='tau (us)', val=50, units=units.ms, field='RF')
        ...
        self.addParameter(key='nPoints', string='nPoints', val=256, field='IM')
