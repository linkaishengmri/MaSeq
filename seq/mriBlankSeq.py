...
class MRIBLANKSEQ:
    ...
    def pypulseq2mriblankseqV2(self, waveforms=None, shimming=np.array([0.0, 0.0, 0.0])):
        # Reset flo dictionary
        self.flo_dict = {'g0': [[], []],
                         'g1': [[], []],
                         'g2': [[], []],
        ...
        for key in waveforms.keys():
            if key == 'tx0':
                ...
                self.flo_dict['lo0_freq_offset'][0] = np.concatenate((self.flo_dict['lo0_freq_offset'][0], waveforms['lo0_freq_offset'][0][:]), axis=0)
                self.flo_dict['lo0_freq_offset'][1] = np.concatenate((self.flo_dict['lo0_freq_offset'][1], waveforms['lo0_freq_offset'][1][:]), axis=0)
            elif key == 'lo1_freq_offset':
                self.flo_dict['lo1_freq_offset'][0] = np.concatenate((self.flo_dict['lo1_freq_offset'][0], waveforms['lo1_freq_offset'][0][:]), axis=0)
                self.flo_dict['lo1_freq_offset'][1] = np.concatenate((self.flo_dict['lo1_freq_offset'][1], waveforms['lo1_freq_offset'][1][:]), axis=0)
            elif key == 'lo0_rst':
                self.flo_dict['lo0_rst'][0] = np.concatenate((self.flo_dict['lo0_rst'][0], waveforms['lo0_rst'][0][:]), axis=0)
                self.flo_dict['lo0_rst'][1] = np.concatenate((self.flo_dict['lo0_rst'][1], waveforms['lo0_rst'][1][:]), axis=0)
            elif key == 'lo1_rst':
                self.flo_dict['lo1_rst'][0] = np.concatenate((self.flo_dict['lo1_rst'][0], waveforms['lo1_rst'][0][:]), axis=0)
                self.flo_dict['lo1_rst'][1] = np.concatenate((self.flo_dict['lo1_rst'][1], waveforms['lo1_rst'][1][:]), axis=0)
