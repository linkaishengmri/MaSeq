...
# 9465307104
class TSEMultisliceT2PSEQ(blankSeq.MRIBLANKSEQ):
    def __init__(self):
        super(TSEMultisliceT2PSEQ, self).__init__()
        ...
        self.addParameter(key='larmorFreq', string='Larmor frequency (MHz)', val=10.53612, units=units.MHz, field='IM')
        ...
        self.addParameter(key='shimming', string='Shimming', val=[0.0018, 0.0016, 0.0032], field='SEQ')
        self.addParameter(key='etl', string='Echo train length', val=8, field='SEQ')
        self.addParameter(key='effEchoTime', string='Effective echo time (ms)', val=20.0*4, units=units.ms, field='SEQ')
        ...
        self.addParameter(key='compReadGrad', string='Read Grad. Compensation', val=[0, 0, 40, 67, 69, 65, 70, 75, 80]
                          ,field='OTH')
    ...
    def sequenceRun(self, plotSeq=0, demo=False, standalone=False):
        ...
        gr_preph_standard = pp.make_trapezoid(
        ...
        def createBatches():
            ...
            for k_ex in range(1, n_ex + 1):
                ...
                for s in range(n_slices):
                    ...
                    batches[batch_num].add_block(gs3, gr3), standard_seq.add_block(gs3, gr_preph_standard)
